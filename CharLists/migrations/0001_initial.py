    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img', models.ImageField(blank=True, null=True, upload_to='media/CharLists/img/alignments/')),
            ],
        ),
        migrations.CreateModel(
            name='background',
            fields=[
                ...
                ('description', models.TextField()),
                ('img', models.ImageField(blank=True, null=True, upload_to='media/CharLists/img/backgrounds/')),
            ],
        ),
        migrations.CreateModel(
            name='characteristic',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField()),
                ('img', models.FileField(blank=True, null=True, upload_to='media/CharLists/img/classes/')),
            ],
        ),
        migrations.CreateModel(
            name='gameRace',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img', models.ImageField(blank=True, null=True, upload_to='media/CharLists/img/persons/')),
                ('alignment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='CharLists.alignment')),
                ('background', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='CharLists.background')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('gameClassMain', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='CharLists.gameclass')),
                ('gameRace', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='CharLists.gamerace')),
            ],
        ),
        migrations.CreateModel(
            name='gameClasses',
